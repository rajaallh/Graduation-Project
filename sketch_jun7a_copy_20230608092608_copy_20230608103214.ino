...
uint8_t rowPins[ROWS]  = { 26, 25, 33, 32 }; // Pins connected to C1, C2, C3, C4
uint8_t colPins[COLS] = { 13, 12, 14, 27 }; // Pins connected to R1, R2, R3, R4
...
tft.print("Rgullah Abdullah");


tft.setCursor(10, 290, 4);
tft.print("Abdalbari Abdullah");


tft.setTextColor(TFT_RED,TFT_BLACK);
tft.setCursor(60, 200, 4);
tft.print("Barrier Ball");
...
volatile int c_x =110 ;   //موقع الدائرة
...
tft.drawString(String(score),10,10,7); // طباعة القيمة بالمتغير x  بالموقع 20 و 240 و حجم خط 7
if(game_steps == 0){
tft.fillScreen(TFT_BLACK);
...
tft.fillSmoothCircle(c_x  , c_y  , b_l, TFT_DARKGREY,TFT_DARKGREY) ;
